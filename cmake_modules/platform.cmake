...
if(APPLE)
    ...
    if(CMAKE_OSX_ARCHITECTURES)
        ...
        string(REGEX MATCH "[aA][aA][rR][cC][hH]64+" aarch64_build "${CMAKE_OSX_ARCHITECTURES}")
        string(REGEX MATCH "[aA][rR][mM]64+" arm64_build "${CMAKE_OSX_ARCHITECTURES}")
        if(x86_64_build)
            add_flag_prepend(CMAKE_Pascal_FLAGS -Px86_64)
        elseif(aarch64_build OR arm64_build)
            add_flag_prepend(CMAKE_Pascal_FLAGS -Paarch64)
            # ARM64 specific: Disable PIE to avoid function pointer issues
            add_flag_prepend(CMAKE_Pascal_FLAGS -k-no_pie)
            message(STATUS "ARM64 detected: Adding -k-no_pie flag for Pascal linker")
        elseif(i386_build)
    ...
    elseif(CMAKE_SIZEOF_VOID_P MATCHES "8")
        #if that variable is not set check architecture - use aarch64 on Apple Silicon, x86_64 otherwise
